...
if __name__ == '__main__':
    ...
    img = cv2.imread('video2_85.png')
    cv2.imshow('original', img)
    # img.set(cv2.img_PROP_FRAME_WIDTH, 1360)
    # img.set(cv2.img_PROP_FRAME_HEIGHT, 800)
    ...
    after = detect(img, maskr, maskg, masky, mdv, srv, brv, p1v, p2v)
